...
@Configuration
@EnableSwagger2
@ComponentScan("com.hang.hangvideosdev.controller")
public class Swagger2 {
	...
	public Docket createRestApi() {
		...
		return new Docket(DocumentationType.SWAGGER_2).apiInfo(apiInfo()).select()
				.apis(RequestHandlerSelectors.basePackage("com.hang.hangvideosdev.controller"))
	...
	private ApiInfo apiInfo() {
		return new ApiInfoBuilder()
				...
				// 设置联系人
				.contact(new Contact("hang", "http://www.hang.com", "www.1007016848@qq.com"))
				// 描述
